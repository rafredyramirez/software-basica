...
function create() {  
    ...
    bmpText = game.add.bitmapText(550, 50, 'carrier_command','Nivel 1 !',34);
    ...
    // texto
    var style = { font: "20px Roboto", fill: "#000000", align: "center" };

    textPresentacion1 = game.add.text(120, 365, `- Hola ${nombreUsuario},  \nacompáñame  en la \nsiguiente aventura.`, style);

    textPresentacion1.anchor.set(0.5);

    textPresentacion1.addColor('#4b862a', 6);
    textPresentacion1.addColor('#000000', (nombreUsuario.length)+7);
}
